            ...
            <div className="contact-us-form-area grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="contact-us-info-wrap">
                <div className="contact-us-info-area">
                  <div
                    className="relative w-full max-w-[100vw] sm:max-w-[96vw] md:max-w-[696px] lg:max-w-[456px] xl:max-w-[100vw] h-[70vh] bg-no-repeat bg-cover bg-center mx-auto
    "
                    style={{ backgroundImage: "url('/images/contact3.jpg')" }}
                  >
                    {/* Overlay content will go here later */}
                  </div>
                </div>
              </div>
            </div>
